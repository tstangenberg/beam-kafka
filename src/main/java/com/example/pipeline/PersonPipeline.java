...
public class PersonPipeline {
    ...
    private static final org.apache.avro.Schema AVRO_SCHEMA = org.apache.avro.Schema.parse("{"
        + "\"type\": \"record\","
        + "\"name\": \"Person\","
    ...
    public static void main(String[] args) {
        PersonPipelineOptions options = PipelineOptionsFactory.fromArgs(args)
                .withValidation()
                .as(PersonPipelineOptions.class);
        ...
        PCollection<Row> personRows = pipeline
            .apply("Read from PostgreSQL",
                JdbcIO.<Row>read()
                    ...
                    .withRowMapper(resultSet -> Row.withSchema(beamSchema)
                        .addValues(
        ...
        PCollection<KV<String, byte[]>> serializedRows = personRows.apply("Serialize to bytes", ParDo.of(new DoFn<Row, KV<String, byte[]>>() {
            ...
            public void startBundle(StartBundleContext c) {
                PersonPipelineOptions options = c.getPipelineOptions().as(PersonPipelineOptions.class);
            ...
            @ProcessElement
            public void processElement(@Element Row row, OutputReceiver<KV<String, byte[]>> out, ProcessContext c) throws IOException {
                PersonPipelineOptions options = c.getPipelineOptions().as(PersonPipelineOptions.class);
        ...
        // Write to Kafka
        serializedRows.apply("Write to Kafka",
